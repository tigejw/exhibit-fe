        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {sortedExhibits.map((exhibit) => (
            <button
              ...
              className="flex max-w-full flex-col rounded-lg border-[0.8px] border-[#3b0000] p-4 text-left bg-neutral-100 transition hover:-translate-y-1.5 hover:shadow-[0_14px_40px_rgba(17,17,17,0.1)]"
            >
